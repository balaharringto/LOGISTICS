...
>
  ...
  >
    ...
    >
      <Box component="img" src={img1} sx={{ width: 100, mr: 3 }} alt="Fast" />
      <Box>
    ...
    <Box 
      sx={{ 
        ...
        alignItems: "center",
        justifyContent: "center",
        ml: 3 // space between Paper and Icon box
      }}
    >
      <MoveToInboxIcon sx={{ fontSize: 48, color: "#222" }} />
      <Typography sx={{ fontWeight: "bold", color: "#58c4ed", mt: 2 }}>
        TAKE 5 MINUTES
      </Typography>
      <Typography variant="body2">To Place Your Order</Typography>
    </Box>
  </Box>